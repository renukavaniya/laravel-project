  ...
  <div class="container col-sm-6">
		<div class="card">
           <!-- <div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong><center><h4>Login</h4 ></center></strong> </div>-->
            <div class="card-body">
               <div class="col-sm-12">
              <h3 class="card-title"><center>Update User</center></h3>
...
<form method="post" enctype="multipart/form-data" id="" action="/updateuser/{{$users->id}}">
                    {{ csrf_field() }}
				...
				<div class="form-group">
				  <label for="gender">Gender:</label><br>
				   ...
				   <input type="radio" id="male" name="gender" value="male" <?php if($users->gender == "male") echo "checked"; ?>>
				  <label for="male">Male</label><br>
				  <input type="radio" id="female" name="gender" value="female" <?php if($users->gender == "female") echo "checked"; ?>>
				 ...
				 <div class="form-group">
				  <label for="state">State:</label>
					  ...
					  <select id="state" name="state">
						  ...
						  <option value="Gujrat" <?php if($users->state == "Gujrat") echo "selected"; ?>>Gujrat</option>
						  <option value="Maharashtra"  <?php if($users->state == "Maharashtra") echo "selected"; ?>>Maharashtra</option>
				  ...
				  <label for="city">City:</span></label>
					  ...
					  <select id="city" name="city">
						  ...
						  <option value="Ahemdabad" <?php if($users->city == "Ahemdabad") echo "selected"; ?>>Ahemdabad</option>
						  <option value="Baroda" <?php if($users->city == "Baroda") echo "selected"; ?>>Baroda</option>
						  <option value="Mumbai"<?php if($users->city == "Mumbai") echo "selected"; ?>>Mumbai</option>
						  <option value="Pune"<?php if($users->city == "Pune") echo "selected"; ?>>Pune</option>
					...
					<br>
                     <div >
                        <button type="submit" name="submit" value="submit" id="submit" class="btn btn-info btn-fill ">Update User</button>
                     </div>
                  </form>
